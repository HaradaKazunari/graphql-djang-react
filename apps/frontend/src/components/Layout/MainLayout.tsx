...
const SideNavigation = () => {
  ...
  const navigation = [
    { name: "ホーム", to: ".", icon: HomeIcon },
    { name: "見積登録", to: "./estimates/add", icon: PlusCircleIcon },
    { name: "受注登録", to: "./contracts/add", icon: PlusCircleIcon },
    { name: "案件一覧", to: "./projects", icon: FolderIcon },
    { name: "請求一覧", to: "./invoices", icon: FolderIcon },
    { name: "締め日管理", to: "./closing-date", icon: CalendarIcon },
